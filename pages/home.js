...
/* this  */
  ...
  async function addUpdateConfidence(confidence,time){
    ...
    newUpdateBlock.className = "jsx-3da9b819f312ae3a  home-container04 textarea"
    updateConfidence.className = 'jsx-3da9b819f312ae3a  home-text02'
    updateConfidence.innerText = ("Confidence Level: " + confidence.slice(1))
    updateTime.className = 'jsx-3da9b819f312ae3a  home-text03'
    updateTime.innerText = ( time.slice(1,29))
    newThreat.innerText = ("Time Stamp:")
    newThreat.className = 'jsx-3da9b819f312ae3a home-text01'
