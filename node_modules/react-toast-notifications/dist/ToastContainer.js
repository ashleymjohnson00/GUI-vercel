...
var placements = {
  ...
  'top-center': { bottom: 0, left: '50%', transform: 'translateX(-50%)' },
  'top-right': { top: 0, left: '50%', transform: 'translateX(-50%)'},
  'bottom-left': { bottom: 0, left: 0 },
  'bottom-center': { bottom: 0, left: '50%', transform: 'translateX(-50%)' },
  'bottom-right': { bottom: 0, right: 0 },
  'center-center':{bottom: 0, left: '50%', transform: 'translateX(-50%)'}
};
